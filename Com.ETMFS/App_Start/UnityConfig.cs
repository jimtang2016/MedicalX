...
namespace Com.ETMFS.App_Start
{
    ...
    public class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<IDataContextFactory<ETMFContext>, DefaultDataContextFactory<ETMFContext>>( new PerRequestLifetimeManager());
            container.RegisterType<IUnitOfWork, UnitOfWork<ETMFContext>>(new PerRequestLifetimeManager());
            container.RegisterType<IOptionListRepository, OptionListRepository>(new PerRequestLifetimeManager());
